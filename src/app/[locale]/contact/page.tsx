        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <Reveal className="flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <a href={`mailto:${email}`} className="flex items-center gap-4 rounded-2xl border border-neutral-200 bg-white p-5 transition hover:border-brand-red/40">
                ...
                <div><p className="text-xs uppercase tracking-wider text-neutral-400">Email</p><p className="font-medium text-brand-ink">{email}</p></div>
              </a>
            ...
            <div className="mt-8 rounded-2xl border border-neutral-200 bg-white p-5">
              <h2 className="mb-3 font-display text-xl text-brand-ink">Ish vaqti</h2>
          ...
          <Reveal delay={0.1} className="flex flex-col">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 inline-flex items-center justify-center gap-2 rounded-xl bg-brand-ink py-3 font-medium text-brand-cream transition hover:bg-brand-ink/90"
            >
              Google Maps&apos;da ochish <ExternalLink size={16} />
            </a>
          </Reveal>
        </div>
      </div>
